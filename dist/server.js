...
app.get("/api/connect", async (_req, res) => {
    try {
        ...
        const result = execSync("/home/arch/.npm-global/bin/wallet-cli session view --output json 2>&1", { encoding: "utf-8", timeout: 8000 });
...
app.get("/api/cli", async (req, res) => {
    const args = req.query.args || "--help";
